...
export const HeroSection: React.FC = () => {
    return (
        <section className="w-full h-auto">
            <div className="relative w-full max-w-360 h-124.25 mx-auto flex">
                ...
                <div className="w-[50%] h-full relative">
                    ...
                    {/* overlay de textos centralizada no bloco esquerdo */}
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center gap-4 p-4">
                        <Heading className="text-rede-yellow blur-[2px] text-[128px] font-medium">
                            Rede
                        </Heading>
