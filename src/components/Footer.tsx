...
type VariantType = {
  variant?: "yellow" | "red" | undefined;
}

export const Footer: React.FC<VariantType> = ({ variant }) => {
  return (
    <footer className="w-full h-auto bg-rede-surface">
      <div className="w-full max-w-360 h-auto mx-auto pt-28 pb-10">
        ...
        <div className="w-full flex">
          ...
          <div className="w-full h-full flex flex-col justify-center items-center gap-4">
            <div className="w-fit">
              <Heading level={"h3"} className="font-medium text-rede-white text-[48px] leading-14 mb-4 text-left">
                Menu
              </Heading>
        ...
        <div className="w-full">
          <div className="w-full max-w-348 h-53.25 mx-auto mt-52.5 mb-2.5">
            <img src={`/assets/footer/${variant ? variant : "yellow"}-logo-footer.svg`} alt="REDE Logo" className="object-cover" />
          </div>
        </div>
