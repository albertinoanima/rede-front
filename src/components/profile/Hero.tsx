        ...
        <div className="absolute inset-0 flex justify-center items-center">
          ...
          <div className='w-full max-w-289 flex gap-5'>
              ...
              <div className='flex flex-col'>
                ...
                <div className='mt-5'>
                  <Button icon={<PhoneIcon width={20} height={20} color='black'/>} iconPosition='left' className='bg-rede-yellow border-none text-rede-surface' iconButtonClassName="border-none">
                    Contactar
                  </Button>
                </div>
