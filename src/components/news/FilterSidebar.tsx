    ...
    <aside className="w-82.75 h-auto pl-6 pr-6 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className='flex flex-col gap-2'>
          ...
          <div className="flex items-center">
            <Input placeholder='Pesquisar...' type='date' className="h-10 w-full rounded-full border-2 border-white bg-transparent px-3 text-rede-white outline-none placeholder:text-rede-white" icon={<ArrowRight size={18} className="text-rede-white" />} iconPosition={"right"} iconContainerClassName='h-10 w-10 rounded-full border-2 border-white p-2.5"' />
          </div>
        </div>
