...
No encontro, aberto com palavras de motivação do Diretor Geral do INICC, Roberto Dove, e que contou com a participação de técnicos do INICC, os profissionais apresentaram igualmente algumas das suas principais preocupações, em particular, questões relacionadas com direitos de autor, reconhecimento profissional, licenciamento, registo de empresas e os desafios de produção nas zonas remotas.<br/><br/>
A REDE e o INICC comprometeram-se a realizar mais encontros desta natureza, para debater na especificidade, algumas destas preocupações.
`,
        date: "Agosto, 2026",
        location: "Moçambique",
...
A equipa local tem ainda, vindo a realizar encontros com outros stakeholders do setor, como a RTTL - Rádiotelevisão de Timor-Leste, a GMN TV, exibidores de cinema comercial e não comercial - o CinePlex, Casa de Produção Audiovisual e Cinema Lorosa’e. Foi ainda concedida uma entrevista à RTTL, por ocasião da presença da Coordenadora-Geral do projecto, em Díli.
O trabalho que pretende reforçar o conhecimento sobre a contribuição do sector audiovisual para as economias nacionais, promovendo a recolha, sistematização e análise de informação, foi ainda apresentado e discutido com a SEAC - Secretaria de Estado da Arte e Cultura; a CNTL - Comissão Nacional de Timor-Leste para a UNESCO; o INE - Instituto Nacional de Estatística; o SERVE,I.P. entidade responsável pelo registo de empresas, e outras.
A nossa expectativa, em Timor-Leste, é recolher e verificar dados de profissionais, associações, coletivos e empresas. O trabalho continua em curso até final de Setembro 2026, estando previstas algumas ações de comunicação e divulgação.
`,
        date: "Junho, 2026",
...
O Programa de filmes foi constituído por cinco longas-metragens de ficção, de Moçambique e Angola, produzidas entre 2016 e 2022 por várias gerações de realizadores; e quase duas dezenas de curtas-metragens, produzidas entre 2016 e 2025, numa selecção feita em colaboração com o KUGOMA - Fórum de Cinema Moçambique, que pretendeu mostrar como a nova geração cria e narra as suas histórias, através da imagem em movimento.
Organizado em seis dias, 12, 13, 14, 19, 20 e 21 de Junho de 2026, o programa foi acompanhado por encontros com profissionais locais, para os integrar nesta rede de trabalho que, esperamos, possa vir a ter impactos positivos num dos sectores criativos mais relevantes da actualidade.<br/><br/>
A REDE de Cinema e Audiovisual PALOP + TL agradece o apoio da Fundação Oriente, que permitiu realizar esta Mostra em Díli; a contribuição de todos os cineastas e produtores que, gentilmente e apaixonadamente, cederam os seus filmes para exibição; a colaboração da nossa equipa - incluindo a recém-formada equipa em Díli; ao público, sem o qual fazer filmes não teria sentido. 
A todo@s,
Obrigadu barak!
`,
        date: "Junho, 2026",
...
A nossa expectativa, em Timor-Leste, é recolher e verificar dados de profissionais, associações, coletivos e empresas, promover alguns encontros profissionais para divulgação de oportunidades e a recolha de perceções e expectativas.
Para mais informações, podem contactar a equipa local, juntando-se ao grupo de WhatsApp através deste link: https://chat.whatsapp.com/D0NKwWs3hnbDVWAOTVKabt`,
        date: "Maio, 2026",
        location: "Timor-Leste",
        countries: ["timor-leste"],
        themes: [
