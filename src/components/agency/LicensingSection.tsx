  ...
  return (
    <section className="w-full bg-[#141414] py-24">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <Heading level={"h2"} className="mb-12 text-5xl font-bold text-white">
        ...
        <div className="mt-16 flex justify-center">
          <Button variant={"primary"} icon={<ArrowRight color="black"/>} iconPosition="left" className="text-rede-black">
            Download Termos (PDF)
          </Button>
        </div>
      </div>
