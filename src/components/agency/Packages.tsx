    ...
    <section className="w-full bg-rede-surface py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Text className="mt-6 text-sm text-rede-white/80 leading-7">
          ...
          {packages.map((item, index) => (
            <div key={index} className="border border-white/40 p-7 flex flex-col">
              ...
              <div className="flex justify-between items-start">
                ...
                <h3 className="text-4xl font-bold text-rede-white">
                  {item.title}
                </h3>
              ...
              <Text className="mt-3 text-xs text-rede-white/60 leading-5 max-w-xs">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              ...
              <div className="grid grid-cols-2 gap-y-3 gap-x-6 mt-8">
                ...
                {[
                  ...
                  <div
                    key={feature}
                    className="flex items-center gap-2 text-rede-white text-sm"
                  >
                    <span>◉</span>
                    <span>{feature}</span>
                  </div>
